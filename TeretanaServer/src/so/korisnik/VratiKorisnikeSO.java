 ...
 * @author Roki
 */
public class VratiKorisnikeSO extends OpstaSistemskaOperacija {
    ...
    protected void izvrsi(Object objekat) throws Exception {
        korisnici = (ArrayList<OpstiDomenskiObjekat>) brokerBaze.vratiSveBezUslova((OpstiDomenskiObjekat) objekat);
    }
